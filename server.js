            ...
            raw => {
                ...
                if (
                    ...
                    const packet = {
                        ...
                        // Preserve the original message ID so edit/delete-for-everyone
                        // can locate and update the same message on both devices.
                        messageId:
                            String(message.messageId || "").slice(0, 100),
