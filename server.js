            ...
            raw => {
                ...
                if (
                    ...
                    if (
                        ...
                        if (!users[code].friendRequests || typeof users[code].friendRequests !== "object") users[code].friendRequests = { incoming: [], outgoing: [] };
                        if (message.friendRequests && typeof message.friendRequests === "object") users[code].friendRequests = message.friendRequests;
                ...
                if (message.type === "add-friend") {
                    ...
                    send(ws, { type: "friend-request-sent", to: target, name: users[target].name || "User" });
                    sendToUser(target, { type: "friend-request", from: info.code, name: user.name || "User", avatar: user.avatar || "" });
                    return;
                }
