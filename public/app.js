/* =====================================================
   VEDCHAT V2
   Messaging + Friends + Groups + Calls
   + Profile Pictures
   + QR
   + Call History
...
function playCallRingtone() {
    ...
    try {
        ...
        if (promise) {
            promise.catch(error => {
                console.log(
                    "Ringtone waiting for user interaction:",
                    error
                );
            });
        }
    ...
    try {
        ...
        if (promise) {
            ...
            promise.catch(error => {
                ...
                console.log(
                    "Notification waiting for user interaction:",
                    error
                );
...
function handleIncomingSound(message) {
...
function handleMessage(message) {
    ...
    /*
     * IMPORTANT:
     * This is where the notification/ringtone
     * system is connected.
     */
...
/* =====================================================
   USER INTERACTION
   Helps browsers unlock audio playback.
===================================================== */
...
document.addEventListener(
    ...
    () => {
        ...
        if (
            ...
            /*
             * Don't leave an old ringtone
             * playing after returning.
             */
